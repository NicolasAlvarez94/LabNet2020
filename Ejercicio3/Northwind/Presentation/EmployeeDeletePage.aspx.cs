...
{
    public partial class EmployeeDeletePage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e) {         
            ...
            this.LoadEmployeesDeleteTable();            
        }


        private void LoadEmployeesDeleteTable() {
            try {             
        ...
        private string GetTextHtmlTable(List<Employee> employees) {         
            ...
            foreach (var employee in employees) {             
                ...
                strHtml += $"<td><a href='ConfirmDeleteEmployee.aspx?idEmployee={employee.EmployeeID}' class='btn btn-danger'>DELETE</a></td>";                              
            }
            return strHtml;
        }
