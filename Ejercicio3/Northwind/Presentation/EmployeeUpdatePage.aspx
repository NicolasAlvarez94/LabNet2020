<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeUpdatePage.aspx.cs" Inherits="Presentation.EmployeeUpdatePage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <h4 class="bg-dark text-center text-white TitleViewPage">UPDATE EMPLOYEE</h4>
    <br />
    ...
    <div class="FormRegisterPage">
        <form>   
            ...
            <a href="ListEmployeeUpdatePage.aspx"> <input type="button" value="PREVIOUS" class="btn btn-primary" /> </a>
